...
*   **Task 1.2:** Setup Vite React project, Login page, and Auth Context.
*   **Task 1.3:** Build Backend: Items, Locations, and Entities CRUD APIs.
*   **Task 1.4:** Build Frontend: Reusable `DataTable`, `FormInput`, and Master Data management UIs.
...
*   **Task 2.2:** Build Frontend: Goods Receipt UI. Reusable `LocationPicker` and `EntitySelector` components.
